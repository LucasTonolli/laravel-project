...
<head>
    ...
    <link id="favicon" rel="shortcut icon" href="{ Vite::asset('resources/images/Frame.svg')}}" sizes="16x16" type="image/svg">
    <link id="favicon" rel="shortcut icon" href="{ Vite::asset('resources/images/Frame.svg')}}" sizes="32x32" type="image/svg">
    <link id="favicon" rel="shortcut icon" href="{ Vite::asset('resources/images/Frame.svg')}}" sizes="48x48" type="image/svg">

    <link rel="apple-touch-icon" sizes="48x48" href="{ Vite::asset('resources/images/Frame.svg')}}">
    <link rel="apple-touch-icon" sizes="72x72" href="{ Vite::asset('resources/images/Frame.svg')}}">
    <link rel="apple-touch-icon" sizes="96x96" href="{ Vite::asset('resources/images/Frame.svg')}}">
    <link rel="apple-touch-icon" sizes="144x144" href="{ Vite::asset('resources/images/Frame.svg')}}">
    <link rel="apple-touch-icon" sizes="192x192" href="{ Vite::asset('resources/images/Frame.svg')}}">
    <link rel="apple-touch-icon" sizes="256x256" href="{ Vite::asset('resources/images/Frame.svg')}}">
    <link rel="apple-touch-icon" sizes="384x384" href="{ Vite::asset('resources/images/Frame.svg')}}">
    <link rel="apple-touch-icon" sizes="512x512" href="{ Vite::asset('resources/images/Frame.svg')}}">
    ...
    <div class="main-wrapper">
        <div class="flex-container">
            <a class="logotipo" href="{{route('site.home')}}">
                <img src="{{ Vite::asset('resources/images/Asset 1.svg')}}">
            </a>
...
<section class="sub__footer">
    <div class="main-wrapper flex-container">
        <a href="#"><img src="{{ Vite::asset('resources/images/Lock-icon.svg')}}">CMS</a>
