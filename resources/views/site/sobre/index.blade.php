    ...
    <div class="green-background">
        ...
        <div class="main-wrapper split-content">
            ...
            <section class="about__content">
                ...
                <section class="about__clients">
                    <div class="about__clients__logos">
                        <img src="{{ Vite::asset('resources/images/logo-5.svg')}}" alt="">
                        <img src="{{ Vite::asset('resources/images/logo-6.svg')}}" alt="">
                        <img src="{{ Vite::asset('resources/images/logo-7.svg')}}" alt="">
                        <img src="{{ Vite::asset('resources/images/logo-8.svg')}}" alt="">
                    </div>
                </section>
            </section>
            ...
            <section class="about__img__values">
                <img src="{{ Vite::asset('resources/images/Pilares.svg')}}" alt="">
            </section>
        </div>
    </div>
@endsection
