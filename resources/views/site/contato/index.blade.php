                ...
                <div class="contact__infos">
                    <div>
                        <div class="contact__infos__header">
                            <img src="{{ Vite::asset('resources/images/phone-contact-icon.svg')}}" alt="">
                    ...
                    <div>
                        <div class="contact__infos__header">
                            <img src="{{ Vite::asset('resources/images/mail-contact-icon.svg')}}" alt="">
                    ...
                    <div>
                        <div class="contact__infos__header">
                            <img src="{{ Vite::asset('resources/images/pin-map-contact-icon.svg')}}" alt="">
