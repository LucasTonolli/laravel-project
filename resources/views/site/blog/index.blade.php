        ...
        <div class="main-wrapper">
            ...
            <div class="blog__older">
                <article class="card__post">
                    <a href="post.php">
                        <div class="post__cover">
                            <img src="{{ Vite::asset('resources/images/blog/blake-connally-B3l0g6HLxr8-unsplash.jpg')}}">
                        </div>
                        <header class="card__post__header">
                ...
                <article class="card__post">
                    <a href="post.php">
                        <div class="post__cover">
                            <img src="{{ Vite::asset('resources/images/blog/kobu-agency-67L18R4tW_w-unsplash.jpg')}}">
                        </div>
                        <header class="card__post__header">
                            <time class="post__date" datetime="2019-03-29">29 Março, 2019</time>
                ...
                <article class="card__post">
                    <a href="post.php">
                        <div class="post__cover">
                            <img src="{{ Vite::asset('resources/images/blog/markus-spiske-hvSr_CVecVI-unsplash.jpg')}}">
                        </div>
                        <header class="card__post__header">
                            <time class="post__date" datetime="2019-03-29">29 Março, 2019</time>
                ...
                <article class="card__post">
                    <a href="post.php">
                        <div class="post__cover">
                            <img src="{{ Vite::asset('resources/images/blog/blake-connally-IKUYGCFmfw4-unsplash.jpg')}}">
                        </div>
                        <header class="card__post__header">
                            <time class="post__date" datetime="2019-03-29">29 Março, 2019</time>
