...
<div class="products__general main-wrapper">
		...
		<article class="card__product">
			<a href="products-detail.php">
				<div class="card__cover">
					<img src="{{ Vite::asset($category->image)}}" style="width: 322px;">
				</div>
	...
	<section class="products__list">
		<header>
			...
			<p>Ususs favere! Tabes grandis palus est. Sunt mensaes magicae fatalis, placidus genetrixes. Cum musa unda, omnes
				amores attrahendam pius, noster particulaes. </p>
		</header>
		...
		<article class="product">
			<a class="clickable-area" href="javascript:;">
				...
				<img class="exclusive__label" src="{{Vite::asset('resources/images/Exclusivo-label.png')}}" alt="Etiqueta de
                        produto
                        exclusivo">
				@endif
			</a>
