        ...
        <div class="main-wrapper">
            ...
            <section class="docked-bar flex-container">
                ...
                <div class="talk-to-us">
                    <img src="{{ Vite::asset('resources/images/Phone-Icon.svg')}}" alt="Telefone Icone">
    ...
    <div class="main-wrapper flex-container">
        <section class="cultivation__category">
            <picture>
                ...
                <img src="{{ Vite::asset('resources/images/rachel-moenning-zjxYwd4HOu0-unsplash.jpg')}}" alt="Capios accelerare, tanquam
            ...
            <img class="home-pattern" src="{{ Vite::asset('resources/images/home-dots-pattern.svg')}}" alt="">
        </section>
        <section class="animal__category">
            <picture>
                <source media="(max-width: 768px)" srcset="{{ Vite::asset('resources/images/andrew-neel-ute2XAFQU2I-unsplash.jpg')}}">
                <img src="{{ Vite::asset('resources/images/andrew-neel-ute2XAFQU2I-unsplash.jpg')}}" alt="Animais, bovino, suíno e aves" width="297"
                     height="447">
            </picture>
            <div class="infos__category">
    ...
    <div class="main-wrapper">
        <div class="blog__container">
            ...
            <article class="card__post">
                <a href="javascript:;">
                    <div class="post__cover">
                        <img src="{{ Vite::asset('resources/images/roman-synkevych-vXInUOv1n84-unsplash.jpg')}}">
                    </div>
                    <header class="card__post__header">
                        <time class="post__date" datetime="2019-03-29">18 Julho, 2019</time>
            ...
            <article class="card__post">
                <a href="javascript:;">
                    <div class="post__cover">
                        <img src="{{ Vite::asset('resources/images/max-duzij-qAjJk-un3BI-unsplash.jpg')}}">
                    </div>
                    <header class="card__post__header">
                        <time class="post__date" datetime="2019-03-29">18 Julho, 2019</time>
            ...
            <section class="flex-container">
                <article class="quote">
                    <div class="avatar__testimonial">
                        <img src="{{ Vite::asset('resources/images/Avatar-testimonial.png')}}">
                    </div>
                    <blockquote>
